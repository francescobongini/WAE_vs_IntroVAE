...
class WAE(object):
    ...
    def salva_test(self):
        for i in range(0,20,2):
            self.salva_pics(i,self.pics)

    def salva_gen_test(self):
        for i in range(1,20,2):
            self.salva_pics2(i,self.pics)
    ...
    def train(self, data):
        ...
        for i in range(0,self.num_pics,100):
