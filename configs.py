...
config_celebA['save_every_epoch'] = 50
config_celebA['print_every'] = 500 #500
config_celebA['work_dir'] = 'results_celeba8'
config_celebA['work_dir2'] = 'results_celeba9'
config_celebA['plot_num_pics'] = 100
config_celebA['plot_num_cols'] = 5

config_celebA['input_normalize_sym'] = True
config_celebA['data_dir'] = '/img_align_celeba/'
...
config_mnist['epoch_num'] = 2 #era 100
...
config_mnist['z_test'] = 'mmd' #posso scegliere anche gan
